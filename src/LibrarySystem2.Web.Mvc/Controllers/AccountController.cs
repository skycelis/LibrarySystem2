...
using LibrarySystem2.Web.Models.Account;
using LibrarySystem2.Web.Views.Shared.Components.TenantChange;

namespace LibrarySystem2.Web.Controllers
{
    public class AccountController : LibrarySystem2ControllerBase
    {
