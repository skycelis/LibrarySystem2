...
using Abp.UI;
using LibrarySystem1.Authentication.External;
using LibrarySystem1.Authentication.JwtBearer;
...
namespace LibrarySystem1.Controllers
{
    ...
    public class TokenAuthController : LibrarySystem1ControllerBase
    {
