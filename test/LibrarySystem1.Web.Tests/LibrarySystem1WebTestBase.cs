...
{
    public abstract class LibrarySystem1WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibrarySystem1WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibrarySystem1WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibrarySystem1DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibrarySystem1DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibrarySystem1DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibrarySystem1DbContext, Task<T>> func)
        {
            T result;
