...
{
    public abstract class LibSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibSystemDbContext, Task<T>> func)
        {
            T result;
